...
const HomePage = () => {
  return (
    <section style={{backgroundImage: 'url(/doc.jpeg)'}}  className="relative min-h-screen flex items-center p-10 bg-cover bg-center">
       ...
       <div className="relative flex flex-col gap-4 md:gap-5 items-center md:items-start text-center md:text-left z-10 md:w-1/3 ">
          ...
          <Button className=" bg-blue-800 hover:bg-blue-700 text-white px-6 py-3 rounded-md shadow-md cursor-pointer"><Link href="/appointments">Book an Appointment</Link></Button>
       </div>
    </section>
  )
}
